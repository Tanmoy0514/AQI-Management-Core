  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="flex flex-col items-center text-center justify-center py-10 relative">
            ...
            <h2 className="text-3xl font-medium mt-2 drop-shadow-md">{maskInfo.status}</h2>
            <p className="opacity-80 mt-1 max-w-md text-lg font-light leading-relaxed">{maskInfo.note}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className={`col-span-1 md:col-span-2 rounded-[2.5rem] p-8 flex items-center justify-between relative overflow-hidden ${theme.card}`}>
                 <div className="relative z-10">
                     ...
                     <h3 className="text-3xl font-bold mb-2">{maskInfo.name}</h3>
                 ...
                 <div className="absolute right-0 bottom-0 opacity-20 transform translate-x-4 translate-y-4">
                     {React.createElement(maskInfo.icon, { size: 180 })}
                 </div>
            </div>
            ...
            <div className={`lg:col-span-2 rounded-[2.5rem] p-8 ${theme.card}`}>
                 <div className="flex items-center gap-3 mb-6">
                     <div className="p-3 bg-white/20 rounded-2xl">
                        {roleInfo && React.createElement(roleInfo.icon, { size: 24 })}
                     </div>
                     <div>
                         <h3 className="font-bold text-xl">Advisor: {roleInfo?.label}</h3>
