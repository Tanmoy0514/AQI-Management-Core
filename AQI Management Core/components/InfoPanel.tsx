...
import { Building2, AlertTriangle, CheckCircle, Sparkles } from 'lucide-react';
...
const InfoPanel: React.FC<InfoPanelProps> = ({ aqiData, darkMode }) => {
  return (
    <div className="mt-auto pt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
       
       {/* 1. Developer System Console */}
