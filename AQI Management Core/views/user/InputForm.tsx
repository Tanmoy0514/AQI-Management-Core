...
const InputForm: React.FC<InputFormProps> = ({
  ...
  const inputClass = `w-full p-4 rounded-2xl border bg-transparent outline-none focus:ring-2 ring-blue-500/50 transition-all font-medium text-lg ${darkMode ? 'border-neutral-700 placeholder:text-neutral-600' : 'border-slate-200 placeholder:text-slate-300'}`;
            ...
            <div className="space-y-4">
                 ...
                 <div className="grid grid-cols-5 gap-4">
                    <div className="col-span-3">
                        <input value={userName} onChange={e => setUserName(e.target.value)} placeholder="Your Name" className={inputClass} />
                    </div>
                    <div className="col-span-2">
                        <input type="number" value={userAge} onChange={e => setUserAge(e.target.value)} placeholder="Age" className={inputClass} />
                    </div>
                 </div>
            </div>
